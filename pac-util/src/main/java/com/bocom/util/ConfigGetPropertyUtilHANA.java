...
public class ConfigGetPropertyUtilHANA {

    private static final String PROPERTIES_PATH = "conf/hana.properties";
    ...
    private ConfigGetPropertyUtilHANA() {
    ...
    public static String get(String key) {
        if (properties.isEmpty()) {
            new ConfigGetPropertyUtilHANA().onStartup();
        }
